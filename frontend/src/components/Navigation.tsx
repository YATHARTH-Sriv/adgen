      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-800 py-4 space-y-4">
            ...
            <a href="#examples" className="block text-gray-300 hover:text-white transition-colors duration-200">
              Examples
            </a>
            <a href="#pricing" className="block text-gray-300 hover:text-white transition-colors duration-200">
              Pricing
            </a>
            <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200">
              Get Started
            </button>
          </div>
        )}
